...
import com.prestobolivia.prestobo.ciphers.StorageCipher;
import com.prestobolivia.prestobo.ciphers.StorageCipherFactory;
...
public class FlutterSecureStorage {
    ...
    public FlutterSecureStorage(Context context, Map<String, Object> options) throws PackageManager.NameNotFoundException {
        ...
        applicationContext =    context.getApplicationContext(); //context.createPackageContext( "com.prestobolivia.prestobo"  , Context.CONTEXT_IGNORE_SECURITY );
